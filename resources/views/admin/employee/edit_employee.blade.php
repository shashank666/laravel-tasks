...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-10 col-xl-8 offset-xl-2 offset-md-1">
                        @include('admin.partials.header_title',['header_title'=>'Edit Employee'])

                        @include('admin.partials.message')
                        <form class="form-horizontal my-4 mx-3" method="POST" action="{{route('admin.save_employee')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input id="empid"  name="empid" type="hidden" value="{{$employee->id}}" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-7 col-12">
                                    <input type="email" id="cmpemail" name="cmpemail" value="{{$employee->cmpemail}}" class="form-control"  />
                            </div>
                        </div>
                        ...
                        <div class="input-group row mb-4">
                            <label for="mobile" class="col-lg-3 col-md-3 col-sm-5 col-12 col-form-label"> Mobile</label>
                                ...
                                <input id="mobile" name="mobile" type="number" style="margin-right: -12px" class="border-left-0 form-control"   placeholder="Mobile Number"  min="100000" max="999999999999999" value="{{$employee->mobile}}" required/>
                            </div>
                        ...
                        <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-5 col-12 col-form-label" for="birthdate">
                                            ...
                                            Date of Birth</label>
                                    <div class="col-lg-9 col-md-9 col-sm-7 col-12">
                                        <input type="text" id="dob" name="dob" placeholder="DD/MM/YYYY" class="form-control text-secondary" value="{{$employee->dateofbirth}}" autocomplete="off"/>
                                    </div>
                        </div>
                        <!--<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-7 col-12">
                                    <input type="text" id="position" name="position" value="{{$employee->position}}" class="form-control"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-5 col-12 col-form-label" for="joindate">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-7 col-12">
                                        <input type="text" id="joindate" name="joindate" placeholder="DD/MM/YYYY" class="form-control text-secondary" value="{{$employee->dateofjoin}}" autocomplete="off"/>
                                    </div>
                        </div>
