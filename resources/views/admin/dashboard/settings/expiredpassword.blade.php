...
@include('admin.partials.header_title',['header_title'=>'Your Password has been expired'])
<div class="container">
    <div class="row">
        <div class="col-md-2 msg">
            ...
            <div class="col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="change-password-form" method="POST" action="{{ route('admin.resetpasswordpost') }}">
                                {{ csrf_field() }}
