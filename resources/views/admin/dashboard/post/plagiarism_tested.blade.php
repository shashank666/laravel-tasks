...
<div class="container">
<div class="row"> 
@foreach($plagiarism_article as $index=>$result)
         ...
         <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <span style="background: #F44336;color: #fff;padding: 7px;margin: 15%;border: dotted white;">Plagiarism : {{$result->plagiarism_percents}}%</span>
                    <span style="background: #ffd700;padding: 7px;margin: 15%;border: dotted white;">Copied Words: {{$result->plagiarised_words}} Words</span>
                </div>
            </div>
        </div>
         <div class="card-footer opinion-footer">
            <div class="row">
                <div class="col-12" style="text-align: center;">
                    <a href="{{$result->comparison_report}}" target="_blank">
                    <button class="btn btn-sm btn-primary"  name="" id="" type="button">Comparison Report</button></a>
                     <a href="{{$result->cached_version}}" target="_blank">
                    <button class="btn btn-sm btn-primary"  name="" id="" type="button">Cached Version Report</button>
                    </a>
                     <a href="{{$result->embeded_comparison}}" target="_blank">
                    <button class="btn btn-sm btn-primary"  name="" id="" type="button">Embeded Comparison Report</button>
                </a>
