<div class="card">
    ...
    <a href="{{ route($route_name) }}">
        ...
        <div class="row align-items-center">
            <div class="col">
                 <p class="mb-2"><span class="mr-2"><i class="fas fa-globe"></i></span> Website <span class="ml-2 badge badge-success p-2"> </span></p>
            </div>
            <div class="col-auto">
                {{ $website_active }}
            </div>
        ...
        <div class="row align-items-center">
            <div class="col">
                <p class="mb-2"><span class="mr-2"><i class="fab fa-android"></i></span> Android <span class="ml-2 badge badge-success p-2"> </span></p>
            </div>
            <div class="col-auto">
                {{ $android_active }}
            </div>
