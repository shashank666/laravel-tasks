...
<script>
    ...
    $(document).on('change','#choose',function(){
     if($('#choose').is(":checked")){
         ...
         $('#imagefile').val('');
         $('#showImageURL').css('display','inline');
     }
    });
...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-10 col-xl-8 offset-xl-2 offset-md-1">
                        @include('admin.partials.header_title',['header_title'=>'Create New Category'])

                        @include('admin.partials.message')
                        <form class="form-horizontal my-4 mx-3" method="POST" action="{{route('admin.create_category')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group row">
                            <label for="name" class="col-md-3 col-sm-5 col-12  col-form-label">Category Name</label>
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-lg-3 col-md-3 col-sm-5 col-12 col-form-label">Category Description</label>
                            <div class="col-lg-9 col-md-9 col-sm-7 col-12">
