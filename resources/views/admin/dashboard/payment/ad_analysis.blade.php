                ...
                <div class="row align-items-end">
                   ...
                   <div class="col-auto">
                    @if($to_pay>0 && $to_pay<2)
                        <a class="btn btn-warning" href="payto">Pay {{$to_pay}} User</a>
                    @elseif($to_pay>1)
                    <a class="btn btn-danger" href="payto">Pay {{$to_pay}} Users</a>
                    @endif
                    <a class="btn btn-light" href="paid_users">Paid Invoices</a>
                </div>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="posts-table" class="table">
                            ...
                            <tbody id="append-div">
                               @include('admin.dashboard.payment.ad_analysis_row')
                            </tbody>
                        </table>
                    </div>
