...
<head>
    ...
    <title>Invitation to access Cpanel - Opined</title>
    <style>
        a {
...
<td height="40">&nbsp; </td>
                                    ...
                                    <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2"
                                        ...
                                        Hi, {{ $name }}</h2>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">You are invited to access the CPanel, Click on the link below and complete the process</p>
                                </td>
                            </tr>
    ...
    <table data-module="button-primary0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
        <tbody>
            <tr>
                <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
                    ...
                    <table class="o_block-xs" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py-xs" align="center" data-bgcolor="Bg White"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text"
                                                    align="center" data-bgcolor="Bg Primary" data-size="Text Default"
                                                    ...
                                                    <a class="o_text-white" href="{{ $verify_url }}"
                                                        target="_blank"
                                                        data-color="White"
                                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Click Here &rarr;</a>
                                                </td>
                                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                            If you have any question, please feel free to contact Administrator.
