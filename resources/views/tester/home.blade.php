...
-->
@include('tester.auth.modal_login')
@include('tester.headertest')
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
            ...
            <h4 class="pb-3 mb-3 font-weight-normal header-card">Threads You Follow<span><a href="threads/followed" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
            <div class="row mb-5">
            ...
            @if(Auth::check() && count($followed_threads)<1) <h4 class="pb-3 mb-3 font-weight-normal header-card">Threads You Follow<span><a
                        href="threads/followed" class="btn btn-sm waves-effect waves-float float-right"
                        style="background-color:#ff9800;color:#fff;outline:none;"><i
                            class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5">
                ...
                @endif
                @if(Auth::guest())
                <h4 class="pb-3 mb-3 font-weight-normal header-card">Threads You Follow<span><a href="#loginModal" class="btn btn-sm waves-effect waves-float float-right" data-toggle="modal" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5" style="margin-left: 0.5%; margin-right: 0.5%">
                <a class="btn btn-block" style="background: #ff9800;color: #244363 !important;" data-toggle="modal" href="#loginModal">Login to See What You Follow</a>
                </div>

                @endif

              @if(Auth::check() && count($circle_threads)>0)
                <h4 class="pb-3 mb-4 font-weight-normal header-card">Trending in Your Circle<span><a href="/threads/trending" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5">
                    @php($colors=['#37474f','#ff9800','#0097a7','#5c007a','#00796b','#d32f2f','#5d4037','#827717','#689f38','#e91e63','#424242','#1565c0','#880e4f','#f57f17'])
            ...
            <h4 class="pb-3 mb-3 font-weight-normal header-card">Trending in Your Circle<span><a href="threads/circle" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5">
                
                <a class="btn btn-block btn-outline-none text-light"  href="" style="color: black !important">Add Friends To Your Circle To See How They Are Opined</a>
               
            </div>
            @endif
            @if(Auth::guest())
                <h4 class="pb-3 mb-3 font-weight-normal header-card">Trending in Your Circle<span><a href="#loginModal" class="btn btn-sm waves-effect waves-float float-right" data-toggle="modal" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5" style="margin-left: 0.5%; margin-right: 0.5%">
                <a class="btn btn-block" style="background: #ff9800;color: #244363 !important;" data-toggle="modal" href="#loginModal">Login to See What's Trending Among Your Friends</a>
                </div>
           ...
           @if(count($threads)>0)
                <h4 class="pb-3 pt-3 mb-4 font-weight-normal header-card">Trending Threads<span><a href="/threads/trending" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                <div class="row mb-5">
                    @php($colors=['#37474f','#ff9800','#0097a7','#5c007a','#00796b','#d32f2f','#5d4037','#827717','#689f38','#e91e63','#424242','#1565c0','#880e4f','#f57f17'])
           ...
           @if(count($latest_threads)>0)
                <div>
                        <h4 class="pb-3 mb-3 font-weight-normal header-card">Latest Threads<span><a href="threads/latest" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
                        <div class="row">
                                @php($colors=['#37474f','#ff9800','#0097a7','#5c007a','#00796b','#d32f2f','#5d4037','#827717','#689f38','#e91e63','#424242','#1565c0','#880e4f','#f57f17'])
...
<!--
        @if(Auth::check() && count($circle_threads)>0)
        <h4 class="pb-3 mb-3 font-weight-normal" style="color:#244363;border-bottom:1px solid #ff9800;">Trending in Your Circle</h4>
        <div class="row mb-5">
                @php($colors=['#37474f','#ff9800','#0097a7','#5c007a','#00796b','#d32f2f','#5d4037','#827717','#689f38','#e91e63','#424242','#1565c0','#880e4f','#f57f17'])
...
-->
        ...
        <h4 class="pb-3 mb-3 font-weight-normal" style="color:#244363;border-bottom:1px solid #ff9800;">{{ '#'.$thread->name }}<span><a href="/thread/{{$thread->name}}" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ff9800;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
        <div class="card-columns mb-5">
...
<!--
      ...
      @if(Auth::check())
            ...
            <div class="circle_posts">
              <h4 class="pb-3 mb-4 font-weight-normal" style="color:#244363;border-bottom:1px solid #ff9800;">From Your Circle<span><a href="/circle" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#244363;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
              <div class="row mb-5">
