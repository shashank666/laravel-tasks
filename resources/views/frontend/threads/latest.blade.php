...
@section('title','Latest Topics - Opined')
@section('description','Explore various latest topics on Opined . Write an opinions for thread your choices.')
@section('keywords','Explore Threads,Business,Current Affairs,Movies,Personalities,Politics,Sports')

@push('meta')
<link rel="canonical" href="https://www.weopined.com/threads/latest" />
<link href="https://www.weopined.com/threads/latest" rel="alternate" reflang="en" />

<!-- Twitter Card data -->
<meta name="twitter:card" content="summary">
<meta name="twitter:site" content="@weopined">
<meta name="twitter:title" content="Latest Threads - Opined">
<meta name="twitter:description" content="Explore latest threads on Opined . Write an opinion for thread your choices.">
<meta name="twitter:creator" content="@weopined">
<meta name="twitter:image" content="https://www.weopined.com/favicon.png">

<!-- Open Graph data -->
<meta property="og:title" content="Latest Threads  - Opined" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://www.weopined.com/threads/latest" />
...
<div class="page-title-wrapper">
    <h1 class="page-title">
        <span data-ui-id="page-title-wrapper">Latest Topics on Opined</span></h1>
</div>

<input id="path" type="hidden" value="{{Request::path()}}" />
<input id="totalpage" type="hidden" value="{{ceil($threads->total()/$threads->perPage())}}" />

    @include('frontend.threads.components.tabs',['section'=>'latest'])
