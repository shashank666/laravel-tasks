...
<head>
    ...
    <title>Reset Password - Opined</title>
    <style>
        a {
...
<body marginwidth="0" marginheight="0"
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px;max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Forgot your password? No issue, it won't taken even a minute to reset it.
    </div>
            ...
            <tr>
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <!--[if mso]><table width="584" cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td align="center"><![endif]-->
                        <div class="o_col-6s o_center o_sans o_text-md o_text-light" data-color="Light" data-size="Text MD" data-min="15" data-max="23" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #82899a;text-align: center;">
                            ...
                            <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20" data-max="40" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                                                ...
                                                <a class="o_text-white"  href="{{ $reset_url }}" target="_blank"  data-color="White"
