...
<body marginwidth="0" marginheight="0"
    ...
    <table data-module="header-white0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">

        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py-md o_sans o_text" align="center" data-bgcolor="Bg White"
                    ...
                    <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-primary" href="https://www.weopined.com"
                            data-color="Primary" style="text-decoration: none;outline: none;color: #126de5;"><img
                                src="https://www.weopined.com/img/logo.png"
                                width="136" height="36" alt="Opined"
    ...
    <table data-module="hero-white-button0"
        data-thumb=""
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">

        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center" data-color="Light" data-size="Text MD"
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            ...
                            Hello {{ $name }} <span style="color: #ff9800">!</span></h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                            Welcome to the Opined family. Here’s some information to get you started with Opined.
                        </p>
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            data-max="40"
                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 20px;line-height: 39px;">
                           Brief about <span style="color: #ff9800">O</span>pined</h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                            Opined is a platform to share and discuss your opinions. Avoid posting merely memes or pics. There are many other platforms where you can do so. 
                        </p>
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            data-max="40"
                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 20px;line-height: 39px;">
                           How it w<span style="color: #ff9800">o</span>rks</h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px; text-align: justify;">
                            1.  Users posts their opinions under opinion threads. You can follows the threads to stay updated on the topics of your choice.<br/>
                            2.  Other users like and comment on those opinions posts and participate in discussions<br/>
                            3.  Your post can be seen by anyone interested in particular thread. You can also view anyone’s opinion by following threads of your choice.<br/>
                            4.  Apart from your opinion posts and discussion, Opined has opinion articles and pills on the platform. You can participate in the polls and read opinion articles.<br/>
                            5.  To write an opinion article, you will have to register yourself as writer.
 
                        </p>
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            data-max="40"
                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 20px;line-height: 39px;">
                           Keep this in <span style="color: #ff9800">M</span>ind</h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px; text-align: justify;">
                            1.  Respect other users and their opinions. <br/>
                            2.  As your opinions are important, so are others’<br/>
                            3.  No personal attacks. There is nothing that cannot be discussed. So discuss as much as you like without individual trolling.<br/>
                            4.  Behave like you would in real life with your friends.<br/>

                        </p>
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            data-max="40"
                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 20px;line-height: 39px;">
                           By The Way<span style="color: #ff9800">...</span></h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px; text-align: justify;">
                            •   This is our <a href="https://www.weopined.com/legal/acceptable_use_policy">Acceptable Use Policy</a>. These are the rules you need to follow to be part of Opined.<br/>
    ...
    <table data-module="content0"
        data-thumb=""
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">

        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py" align="center" data-bgcolor="Bg White"
                    style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    <!--[if mso]><table width="584" cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td align="center"><![endif]-->
                    <div class="o_col-6s o_sans o_text o_text-secondary o_center" data-color="Secondary"
                        data-size="Text Default" data-min="12" data-max="20"
                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;max-width: 584px;color: #424651;text-align: center;">
                        <p style="margin-top: 0px;margin-bottom: 0px;">If you have any questions, please feel free to contact us <a href="http://www.weopined.com/contactus" style="color:#007bff;text-decoration:none;">here </a>. We are always happy to help you and improve your experience on Opined.
                        <br/><br/>Cheers! 🍺<br/>Opined Team
                        </p>
                    </div>
                    <!--[if mso]></td></tr></table><![endif]-->
                </td>
    ...
    <table data-module="spacer-lg0"
        data-thumb=""
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">

        <tbody>
            <tr>
                <td class="o_bg-white" style="font-size: 48px;line-height: 48px;height: 48px;background-color: #ffffff;"
