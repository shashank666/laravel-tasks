...
<head>
    ...
    <title>Account Verified Successfully - Opined</title>
    <style>
        a {
        ...
        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py-md o_sans o_text" align="center" data-bgcolor="Bg White"
                    ...
                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 24px;padding-bottom:0px;">
            ...
            <tr>
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center" data-color="Light" data-size="Text MD"
                        ...
                        <table class="o_center" role="presentation" style="text-align: center;margin-left: auto;margin-right: auto;" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    <tr>
                                        <td class="o_bb-primary" data-border-bottom-color="Border Primary 2" style="border-bottom: 1px solid #126de5;" width="32" height="40">&nbsp; </td>
                                        <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" data-size="Text Default" data-min="12" data-max="20" data-color="Secondary" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;" align="center">
                                         <p style="max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;font-size:32px;">✅</p>
                                        </td>
                                        <td class="o_bb-primary" data-border-bottom-color="Border Primary 2" style="border-bottom: 1px solid #126de5;" width="32" height="40">&nbsp; </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="font-size: 8px; line-height: 8px; height: 8px;">&nbsp;
                                        </td>
                                        <td style="font-size: 8px; line-height: 8px; height: 8px;">&nbsp;
                                        </td>
                                    </tr>
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            ...
                            Account Successfully Verified</h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                                Hi {{ $name }} , Your registered Email Address {{$email}} has been verified successfully.
                        </p>
                    </div>
            ...
            <tr>
                <td class="o_bg-white o_px-md o_py" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text o_text-secondary o_center" data-color="Secondary"
                        ...
                        <p style="margin-top: 0px;margin-bottom: 0px;">If you have any questions, please feel free to contact us <a href="https://www.weopined.com/contactus" style="color:#007bff;text-decoration:none;">here </a>. We are always happy to help you and improve your experience on Opined.
                    ...
                    <div class="o_col o_col-4"
                        ...
                        <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center" data-color="Light"
                            ...
                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                <a class="o_text-light o_underline" href="https://www.weopined.com/contactus" data-color="Light"
                                ...
                                <a class="o_text-light o_underline" href="https://www.weopined.com/legal/terms_of_service" data-color="Light"
                                    style="text-decoration: underline;outline: none;color: #82899a;">Terms Of Service</a>
                                <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg"
                                    style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                                <a class="o_text-light o_underline" href="https://www.weopined.com/legal/privacy_policy" data-color="Light"
