...
<head>
    ...
    <title>Verify Email Address - Opined</title>
    <style>
        a {
...
<body marginwidth="0" marginheight="0"
        ...
        <tbody>
            <tr>
                <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center" data-bgcolor="Bg Light"
                    ...
                    <table class="o_block-xs" width="100%" cellspacing="0" cellpadding="0" border="0"
                        role="presentation" style="max-width: 432px;margin: 0 auto;">
                                ...
                                <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        <a class="o_text-white"
                                            href="https://www.weopined.com" data-color="White"
    ...
    <table data-module="hero-icon-lines0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
        <tbody>
            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    align="center" data-bgcolor="Bg Ultra Light" data-color="Light" data-size="Text MD"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" data-size="Text Default" data-min="12" data-max="20" data-color="Secondary" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;" align="center">
                                                     <p style="max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;font-size:32px;">✉️</p>
                                                    </td>
                                                    <td class="o_bb-primary" data-border-bottom-color="Border Primary 2" style="border-bottom: 1px solid #126de5;" width="32" height="40">&nbsp; </td>
                                                </tr>
                                                <tr>
...
<td height="40">&nbsp; </td>
                                    ...
                                    <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2"
                                        ...
                                        Verify E-mail Address</h2>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Hi
                                            {{ $name }} , please confirm your email address by entering the OTP.</p>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>OTP</strong></p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="284"
                                                    ...
                                                    align="center" data-bgcolor="Bg Ultra Light" data-size="Text XS"
                                                    ...
                                                    <p class="o_text-dark" data-color="Dark"
                                                        style="color: #242b3d;margin-top: 0px;margin-bottom: 0px;">
                                                        <strong>{{ $email_otp}}</strong></p>
                                                </td>
                                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                            If you have any questions, please feel free to contact us <a href="https://www.weopined.com/contactus" style="color:#007bff;text-decoration:none;">here </a>. We are always happy to help you and improve your experience on Opined.
    ...
    <table data-module="footer-white0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
