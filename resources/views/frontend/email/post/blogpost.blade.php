...
<body marginwidth="0" marginheight="0"
    ...
    <table data-module="header-primary-link0"
    ...
    <table data-module="hero-primary-button0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center"
                                    ...
                                    style="background-color: #fff;padding-left: 24px;padding-right: 24px;padding-top:64px;padding-bottom:32px;">
                                    ...
                                    <div class="o_col-6s o_center o_sans o_text-md o_text-white" data-color="White"
                                        ...
                                        <a href="{{ $post_link }}" target="_blank" style="color:#242b3d;text-decoration:none;">
                                        ...
                                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                                              Article Published By
                                                <a href="{{ $post_userlink }}" style="color:#007bff;text-decoration:none;">{{ $post_user }}</a> on
                                                {{ $post_createdat }}
                                        </p>
                            ...
                            <tr>
                                <td class="o_bg-white o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                            ...
                                            src="{{ $post_cover }}"
                                            width="800" height="352" alt=""
                                            style="max-width: 800px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;width: 100%;"
                                            data-crop="false"></a></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py" align="center" data-bgcolor="Bg White"
                                    ...
                                    <div class="o_col-6s o_sans o_text o_text-secondary o_center" data-color="Secondary"
                                        ...
                                        <a href="{{ $post_link }}" target="_blank" style="color: #666666;text-decoration:none;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                                                        data-bgcolor="Bg Primary" data-size="Text Default" data-min="12" data-max="20"
                                                        ...
                                                        <a class="o_text-white"  href="{{ $post_link }}" target="_blank"  data-color="White"
    ...
    <table data-module="footer-white-3cols0"
