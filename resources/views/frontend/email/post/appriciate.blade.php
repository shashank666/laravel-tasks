...
<body marginwidth="0" marginheight="0"
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px;max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
            Thank you for joining Opined platform and writing your article.
    </div>
                ...
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center" data-color="Light" data-size="Text MD"
                        ...
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                                Dear {{ $name }}, Thank you for joining Opined and writing your article
                                <a href="{{ $post_link }}" target="_blank" style="color:#007bff;text-decoration:none;">{{ $post_title }}</a>
                                . We value your efforts and quality of work.
                                <br/><br/>
                                Hope you are enjoying our platform while discussing your opinions. We would like to take this
                                opportunity to make you acquainted with our threads where you can share and discuss your short
