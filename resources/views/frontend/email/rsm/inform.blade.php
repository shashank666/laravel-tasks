...
<head>
    ...
    <title>Thanks For Writing an Article on Opined</title>
    <style>
        a {
                ...
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center" data-color="Light" data-size="Text MD"
                        ...
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                                Dear {{ $name }}, Thank you for publishing your article,
                                <a href="{{ $post_link }}" target="_blank" style="color:#007bff;text-decoration:none;">{{ $post_title }}</a>
                                , on Opined. We value your efforts and quality of work.
                                <br/><br/>
                                Your article will be reviewed as per our Revenue Sharing Model eligibility criteria and you will be informed whether it is eligible or not.
                                <br/><br/>
                                Hope you are enjoying our platform while discussing your opinions. We would like to take this opportunity to make you acquainted with our threads where you can share and discuss your short opinions as well. We look forward to valuable discussions with you on the threads of your choice.
                        </p>
                    </div>
