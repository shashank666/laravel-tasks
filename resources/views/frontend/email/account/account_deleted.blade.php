...
<head>
    ...
    <title>Opined Account Deleted</title>
    <style>
        a {
...
<body marginwidth="0" marginheight="0"
    ...
    <table data-module="hero-white-icon-outline0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center" data-color="Light" data-size="Text MD"
                            ...
                            <tbody>
                                <tr>
                                    <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max"
                                        align="center" data-color="Secondary" data-size="Text Default" data-min="12"
                                        data-max="20" data-border-top-color="Border Primary"
                                        data-border-bottom-color="Border Primary"
                                        data-border-left-color="Border Primary" data-border-right-color="Border Primary"
                                        ...
                                        <img src="https://i.imgur.com/bTu0fEL.png"
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            ...
                            Your Account Was Deleted</h2>
                        <p style="margin-top: 0px;margin-bottom: 0px;">
                            This message confirms that your Opined Account was deleted.
                        </p>
                    </div>
    ...
    <table data-module="button-dark0"
        width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" class="">
        <tbody>
            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td width="300" class="o_btn o_bg-dark o_br o_heading o_text" align="center"
                                    ...
                                    <a class="o_text-white" href="https://www.weopined.com/contactus" data-color="White"
                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Contact
                                        Support</a>
                                </td>
                            </tr>
