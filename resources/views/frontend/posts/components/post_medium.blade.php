...
<div class="card mb-4 box-shadow" id="post-{{$post->id}}">
     <a href="/opinion/{{$post->slug}}"><img class="card-img-top" src="{{$post->coverimage}}" alt="{{$post->title}}" height="400" width="700"  onerror="this.onerror=null;this.src='/img/noimg.png';"></a>
    <div class="card-body">
  ...
  <a href="/opinion/{{$post->slug}}" class="post-body"><p class="card-text">{!!str::limit($post->plainbody,$limit = 260, $end = '...')!!}</p></a>
    ...
    <div class="card-footer bg-white">
            <div class="float-left">
                    <button  id="share-{{$post->id}}"  type="button" class="btn btn-outline-success dropdown-toggle share-opinion" data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false"><i class="fas fa-share mr-2"></i>Share</button>
