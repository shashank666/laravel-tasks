                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control" id="state" name="state"  autocomplete='address-level1' required>
                                                ...
                                                <option value="{{ $state }}" {{ $state ==$account->state?'selected':'' }}>{{ $state }}</option>
                                                @endforeach
                                        </select>
                                        <div class="invalid-feedback"></div>
                                </div>
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account_holdername"  name="account_holdername" value="{{ $account->account_holdername }}" autocomplete="nope" required>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account_no" name="account_no" value="{{ $account->account_no }}" autocomplete="nope" required>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                </div>
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 col-12">
                                                ...
                                                <select class="form-control" id="account_type" name="account_type" required>
                                                        ...
                                                        <option value="saving" {{ $account->account_type =='saving'?'selected':''}} >Saving Account</option>
                                        ...
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="bank_ifsc_code" name="bank_ifsc_code" value="{{ $account->bank_ifsc_code }}" autocomplete="nope"  required>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                </div>
