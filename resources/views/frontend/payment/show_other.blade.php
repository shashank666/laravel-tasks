                ...
                <div class="card mt-5 shadow">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  id="country" name="country" value="{{ $account->country }}" autocomplete='address-level1' readonly disabled/>
                                ...
                                <span>We will send your payments to your registered email address through PayPal and you will recieve payment in your PayPal account. If you don't have an account, you can create one in seconds, for free. You will recieve instructions to setup your account in the mail.</span>
