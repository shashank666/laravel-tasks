            ...
            @include('frontend.partials.message')
                ...
                <div class="card mt-5 shadow">
                        <div class="card-header bg-light">
                                <h5 class="text-center  mb-0 font-weight-normal">Writer's Details</h5>
                        </div>
                        <div class="card-body">
                                {{csrf_field()}}
                                <div class="form-row">
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea rows="2" class="form-control" id="address" name="address"   autocomplete='street-address' readonly disabled>{{ $account->address }}</textarea>
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="zip_code" id="zip_code"  value="{{ $account->zip_code }}" pattern="[1-9][0-9]{5}" autocomplete='postal-code' readonly disabled/>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"  id="city" name="city" value="{{ $account->city }}" autocomplete='address-level2' readonly disabled/>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  id="state" name="state" value="{{ $account->state }}" autocomplete='address-level1' readonly disabled/>
                                        <!--<select class="form-control" id="state" name="state"  autocomplete='address-level1' required>
                                                <option selected disabled>Select State</option>
                                                @foreach($states as $state)
                                                <option disabled value="{{ $state }}" {{ $state ==$account->state?'selected':'' }}>{{ $state }}</option>
                                                @endforeach
                                        </select>-->
                                        <div class="invalid-feedback"></div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  id="bank_name" name="bank_name" value="{{ $account->bank_name }}" readonly disabled/>
                                       <!-- <select class="form-control" id="bank_name"  name="bank_name" required>
                                                <option disabled value="{{ $account->bank_name }}" selected>{{ $account->bank_name }}</option>
                                        </select>-->
                                        <div class="invalid-feedback"></div>
                                </div>
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account_holdername"  name="account_holdername" value="{{ $account->account_holdername }}" autocomplete="nope" readonly disabled>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account_no" name="account_no" value="{{ $account->account_no }}" autocomplete="nope" readonly disabled>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                </div>
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 col-12">
                                                ...
                                                <input class="form-control" type="text"  id="account_type" name="account_type" value="{{ $account->account_type}}"  readonly disabled/>
                                               <!-- <select class="form-control" id="account_type" name="account_type" required>
                                                        <option selected disabled>Select Account Type</option>
                                                        <option disabled value="saving" {{ $account->account_type =='saving'?'selected':''}} >Saving Account</option>
                                                        <option disabled value="current"  {{ $account->account_type =='current'?'selected':''}}>Current Account</option>
                                                </select>-->
                                                <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="bank_ifsc_code" name="bank_ifsc_code" value="{{ $account->bank_ifsc_code }}" autocomplete="nope"  readonly disabled>
                                                        <div class="invalid-feedback"></div>
                                                </div>
                                        </div>
                                </div>

                                <button type="button"  class="btn btn-success btn-block" onclick="window.location.href='{{ route('show_payment_page') }}'">EDIT DETAILS</button>
                        </div>
                </div>
                </form>
        </div>
