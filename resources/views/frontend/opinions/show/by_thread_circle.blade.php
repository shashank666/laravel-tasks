...
@section('title',"Latest opinions in your circle about ".ucfirst($thread->name). " - Opined")
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      $('#first_try').click(function(){
        $('.create_opinion').focus();
      });
...
<div class="page-title-wrapper">
    <h1 class="page-title">
        <span data-ui-id="page-title-wrapper">Latest opinions For You about {{ucfirst($thread->name)}} | Opined</span></h1>
</div>
...
<div class="row">
        <div class="col-lg-3">
            ...
            <div class="d-xl-block d-lg-block d-md-block d-sm-none d-none">
               <h4 class="pb-3 mb-4 font-weight-normal" style="color:#244363;border-bottom:1px solid #495057;">Trending Threads<span><a href="/threads/trending" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#ffffff;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
        ...
        <div class="col-lg-6">
            ...
            @include('frontend.opinions.components.tabs',['section'=>'circle'])
            <div class="tab-content">
                ...
                <div id="circle" class="tab-pane fade show active">
                  ...
                  @if(count($circle_opinions)>0)
                   <div id="append-div">
                      	@include('frontend.opinions.show.by_thread_cards.circle')
                   </div>
                      @include('frontend.partials.spinner')
                  @else
                  <h5 class="mb-3 mb-2">No Opinion to Show</h5>
                    <input class="btn btn-primary btn-block mb-5" type='button' value='Be the first in your circle and share your opinion' id='first_try' name='first_try'><br>
                  @endif
                </div>
              </div>
