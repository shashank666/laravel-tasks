...
@section('title',"Latest opinions about ".ucfirst($thread->name). " - Opined")
...
<div class="page-title-wrapper">
    <h1 class="page-title">
        <span data-ui-id="page-title-wrapper">Latest opinions about {{ucfirst($thread->name)}} | Opined</span></h1>
</div>
...
<div class="row">
        <div class="col-lg-3">
            ...
            <div class="d-xl-block d-lg-block d-md-block d-sm-none d-none">
               <h4 class="pb-3 mb-4 font-weight-normal" style="color:#244363;border-bottom:1px solid #495057;">Trending Topics<span><a href="/threads/trending" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#fff;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
        ...
        <div class="col-lg-6">
            ...
            @include('frontend.opinions.components.tabs',['section'=>'latest'])
            <div class="tab-content">
                <div id="latest" class="tab-pane fade show active">
                  <!--<h3>Latest Opinions</h3>-->
                  @if(count($opinions)>0)
                   <div id="append-div">
                      @include('frontend.opinions.show.by_thread_cards.latest')
                   </div>
