...
@section('title',ucfirst($thread->name). " - Opined | Discuss your opinion about ".ucfirst($thread->name))
...
<div class="page-title-wrapper">
    <h1 class="page-title">
        <span data-ui-id="page-title-wrapper">Trending opinions about {{ucfirst($thread->name)}} | Opined</span></h1>
</div>
...
<div class="row">
        <div class="col-lg-3">
            ...
            <div class="d-xl-block d-lg-block d-md-block d-sm-none d-none">
               <h4 class="pb-3 mb-4 font-weight-normal" style="color:#244363;border-bottom:1px solid #495057;">Trending Threads<span><a href="/threads/trending" class="btn btn-sm waves-effect waves-float float-right" style="background-color:#495057;color:#fff;outline:none;"><i class="fas fa-arrow-right"></i></a></span></h4>
