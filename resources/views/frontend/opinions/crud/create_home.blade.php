                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 d-xl-inline d-lg-inline d-md-inline d-sm-none d-none">
                                 ...
                                 <span style="font-size:1.3vw;" id="btn_add_image" class="mr-2 text-primary" data-toggle="tooltip" title="Add Photos" data-placement="top" onclick="openFileChooser();"><i class="far fa-image" style="color:#495057"></i></span>
                                <span style="font-size:1.2vw;" id="btn_add_gif" class="mr-2 text-success" data-toggle="tooltip" title="Add GIF" data-placement="top" onclick="openAddGIFModal('writeopinion');"><i class="far fa-sticky-note" style="color:#495057"></i></span>
                                 ...
                                 <span style="font-size:1vw;" id="btn_add_embed" class="mr-2 text-dark" data-toggle="tooltip" title="Add Embed Code" data-placement="top" onclick="openAddEmbedCodeModal();"><i class="fas fa-code" style="color:#495057"></i></span>
                                <button type="button" id="btn_submit_opinion" style="width: 80%;height: 40%;margin-top: 28%;margin-right: 16px;" class="btn btn-sm btn-success float-right">Post <i class="fas fa-paper-plane"></i></button>
