...
@endphp
<div class="card my-4" id="opinion_{{$opinion->id}}">
        <div class="card-header opinion-header" style="border-top-left-radius: 20px;border-top-right-radius:20px">
                <div class="media align-items-center">
                    <a href="{{ route('user_profile', ['username' => $user['username']]) }}"  data-placement="right" title="Go to the profile of {{ucfirst($user['name'])}}"><img class="rounded-circle" src="@php
    ...
    @endphp" height="40" width="40" alt="{{ucfirst($user['name'])}}" onerror="this.onerror=null;this.src='https://opined-s3.s3.ap-south-1.amazonaws.com/storage/app/public/profile/user.png';"/></a>
                     <div class="media-body    ">
                        <div class="d-flex justify-content-between align-items-bottom w-100">
                         <div class="content">
                         <span class="ml-2 user_{{$index}} viewinfo" data-cardshow="{{$index}}" title='Please wait..' id="user_{{$user['id']}}"><a href="{{ route('user_profile', ['username' => $user['username']]) }}" style="color:#212121;">{{ucfirst($user['name'])}}</a><br/>
        ...
        <div class="card-body opinion-body" style="overflow-x:hidden;overflow-y:hidden">
         ...
         <div class="card-footer opinion-footer" style="border-bottom-left-radius: 20px;border-bottom-right-radius:20px">
            ...
            <div class="like_comment_div">
                ...
                <span class="like_guest" data-placement="top" title="Please Login To Like"  data-dismiss="modal" data-toggle="modal" data-target="#loginModal"><i class="far fa-arrow-alt-circle-up mr-1 like-icon-opined"></i>
                ...
                <span class="dislike_guest" data-placement="top" title="Please Login To Disagree"  data-dismiss="modal" data-toggle="modal" data-target="#loginModal"><i class="far fa-arrow-alt-circle-down mr-1 ml-1 like-icon-opined"></i>
                ...
                <span class="mr-4 showComment" data-opinion="{{$opinion->id}}"  data-placement="top" title="Please Login To Comment"><i class="far fa-comments mr-1 ml-1 comment-icon-opined"></i>
...
<span data-toggle="tooltip" data-placement="top" title="{{$opinion->views}} Impressions"><i  class="fas fa-eye mr-2"></i>{{$opinion->views}}</span>
 ...
 @endif
    ...
    <span class="col showComment comment-icon-text" id="comment_count_{{$opinion->id}}" data-opinion="{{$opinion->id}}">
