@extends('frontend.layouts.landinglayout')
				...
				<svg width="337" height="222" viewBox="0 0 337 222" xmlns="http://www.w3.org/2000/svg">
				    <defs>
				        <linearGradient x1="50%" y1="55.434%" x2="50%" y2="0%" id="header-shape-1">
				            <stop stop-color="#eeaa18" stop-opacity="0" offset="0%"/>
				            <stop stop-color="#eeaa18" offset="100%"/>
				        </linearGradient>
				    </defs>
				...
				<svg width="128" height="128" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
				    <defs>
				        <linearGradient x1="93.05%" y1="19.767%" x2="15.034%" y2="85.765%" id="header-shape-2">
				            <stop stop-color="#eeaa10" offset="0%"/>
				            <stop stop-color="#eeaa10" offset="100%"/>
				        </linearGradient>
				    </defs>
            ...
            <div class="container">
                <div class="site-header-inner">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-8 col-8 d-flex justify-content-end align-items-center " style="margin-top: 5px;">
                        <a class="btn btn-sm  d-md-inline d-sm-none d-none mr-3 font-change" href="/login_form" title="Login To Opined" style="border: none;background: none;"></i>Login</a>
                        <a class="btn btn-sm  d-md-inline d-sm-none d-none mr-3"   href="/register_form" title="Get Started With Opined" style="border: none;background: none;">Register</a>
                        <a class="btn btn-sm  d-md-inline d-sm-none d-none mr-3" href="/home" title="Threads on Opined" style="border: none;background: none;"></i>Explore</a>
                        <a class="btn btn-sm  d-md-inline d-sm-none d-none mr-3" href="https://play.google.com/store/apps/details?id=com.app.weopined" title="Threads on Opined" style="border: none;background: none;"></i>Get Opined App</a>
                        <div class="d-md-none d-sm-inline d-inline">
                            <div class="btn-group">
                              {{-- <a class="btn btn-sm " href="/login_form" title="Login To Opined" style="border: none;background: none;"></i>Login</a> --}}
                              <a class="btn btn-sm " href="/register_form" title="Create New Account" style="border: none;background: none;"></i>Sign Up</a>
                            <a class="btn btn-sm " href="/home" title="Threads on Opined" style="border: none;background: none;"></i>Explore</a>
                            {{-- <a class="btn btn-sm  mr-2" href="/polls" title="Vote Polls on Opined" style="border: none;background: none;">Polls</a> --}}
                          </div>
                         </div>
                    </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Where Every Opinion Matters</h1>
	                        <p class="hero-paragraph">A Platform for Meaningful Opinions and Disccussions.</p>
							<div class="hero-form field field-grouped">
								{{--  <div class="control control-expanded">
									<input class="input" type="email" name="email" placeholder="Your best email&hellip;">
								</div>  --}}
                                <div class="control">
									<a class="button button-primary button-block" href="https://play.google.com/store/apps/details?id=com.app.weopined" >Download App</a>
                                </div>
                                <div class="control">
									<a class="button button-primary button-block" href="/login_form">Sign In</a>
                                </div>
							</div>
						</div>
						...
						<div class="hero-illustration">
                            ...
                            <div class="hero-shape "  style="margin-top: 20px;">
                                <img src="/img/mockbig.png" height="600;" width="auto"  alt="Opined" /> 
                                </div>
								<svg width="940" height="647" viewBox="0 0 940 647" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow:visible">
									<defs>
										<linearGradient x1="100%" y1="0%" x2="0%" y2="100%" id="hero-illustration-a">
											<stop stop-color="#eeaa18" offset="0%"/>
											<stop stop-color="#eeaa18" offset="100%"/>
										</linearGradient>
									...
									<g fill="none" fill-rule="evenodd">
										...
										{{--  <g class="anime-element fadeleft-animation">
											...
											{{--  <g>
												...
												<path fill="/img/opinion2.png" d="M28 24h12v96H28z" transform="translate(396 333)"/> 
                                                <img src="/img/opinion2.png" id="logo"  height="150px;" width="300px;"  alt="Opined" transform="translate(396 333)>
												
											</g>  --}}
                                             {{--  <g transform="translate(396 157)">
                                            <img src="/img/opinion2.png" id="logo"  height="200px;" width="400px;"  alt="Opined">
                                            </g>  --}}
										</g>
										<g class="anime-element fadeleft-animation">
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">A Truly Meaningful Social Media Platform </h2>
                                <p class="section-paragraph">Opined is platform for meaningful discussions rather than random posts.</p>
                            </div>
                        </div>
						<div class="features-wrap">
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Opinion Feed</h4>
                                    <p class="text-sm">A feed page specially curated for you based on your preferences and connections. Now stay updated with what’s happening around you.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Video Opinions</h4>
                                    <p class="text-sm">Now express your opinions with all the emotions. Share or watch video opinions.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Explore New Topics</h4>
                                    <p class="text-sm">Keep yourself updated with trending topics. What the world is talking about them? Where is the buzz!	</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Polls</h4>
                                    <p class="text-sm">Create or participate in the polls. Share with your friends and get their views.</p>
                                </div>
                            </div>
						</div>
                    </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="brand footer-brand">
						<div class="col-xl-5 col-lg-5 col-md-5 col-sm-4 col-4 col-mob">
							...
							<a class="blog-header-logo text-dark" href="/" title="Opined">
							  ...
							  <div class="d-md-none d-sm-inline d-inline">
								<img src="/img/logo-white.png" id="logo" height="37px;" width="37px;" style="margin-top: 7px; margin-left: -12px;" alt="Opined">
							  </div>
							</a>
						</div>
                    </div>
                    <ul class="footer-links list-reset">
                        <li>
                            <a href="https://www.weopined.com/contactus">Contact</a>
                        </li>
                        <li>
                            <a href="https://www.weopined.com/legal/privacy_policy">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="https://www.weopined.com/legal/terms_of_service">Terms of Service</a>
                        </li>
                        <li>
                            <a href="https://play.google.com/store/apps/details?id=com.app.weopined" target="_blank">Install Opined App</a>
                        </li>
                    </ul>
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/weopined/"  target="_blank">
                        ...
                        <li>
                            <a href="https://twitter.com/weopined?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/company/13682382/admin/" target="_blank">
                                <span class="screen-reader-text">LinkedIn</span>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 30 30" width="16" height="16">
                                    <g id="surface224747698">
                    ...
                    <div class="footer-copyright">&copy; 2021 Copyright Opined</div>
                </div>
            </div>
        </footer>
    </div>

    <script src="js/landing/main.min.js"></script>
</body>
@endsection