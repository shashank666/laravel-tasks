...
@section('title','Contest - Opined - Where Every Opinion Matters !')
...
<!--   
    ...
    <div class="col-12">
      ...
      <div class="latest_posts" style="padding-top: 1.5%;">
          <h4 class="pb-3 mb-4 font-weight-normal" style="color:#244363;border-bottom:1px solid #ff9800;">Live Contest<span><a href="/latest" class="btn btn-sm waves-effect waves-float float-right btn-article"><i class="fas fa-arrow-right"></i></a></span></h4>
          <div class="row mb-5">
              @foreach($contest as $contest)
                  @include('frontend.contest.components.contest_horizontal')
              @endforeach
          </div>
      </div>
      ...
      <div class="mostliked_posts">
          <h4 class="pb-3 mb-4 pt-3 font-weight-normal" style="color:#244363;border-bottom:1px solid #ff9800;">Closed Contest<span><a href="/mostliked" class="btn btn-sm waves-effect waves-float float-right btn-article"><i class="fas fa-arrow-right"></i></a></span></h4>
          <div class="row mb-5">
