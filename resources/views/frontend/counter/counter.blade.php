      ...
      <div class="row">
        <div class="col-4">
          ...
          <div class="row" style="justify-content: center;">
             <a href="{{route('opinions')}}"><p style="color: black !important;">Opinions</p></a>
          </div>
        </div>
        <div class="col-4">
          <div class="row" style="justify-content: center; font-size: 2rem;">
          ...
          <div class="row" style="justify-content: center;">
            <a href="{{route('in_circle')}}"><p style="color: black !important;">Followers</p></a>
          </div>
        </div>
        <div class="col-4">
          <div class="row" style="justify-content: center; font-size: 2rem;">
          ...
          <div class="row" style="justify-content: center;">
            <a href="{{ route('circle') }}"><p style="color: black !important;">Following</p></a>
          </div>
        </div>
        {{--  <div class="col-3">
          <div class="row" style="justify-content: center; font-size: 2rem;">
          ...
          <div class="row" style="justify-content: center;">
            <a href="{{ route('myallarticles') }}"><p style="color: black !important;">Articles</p></a>
          </div>
        </div>  --}}
      </div>
    </div>
