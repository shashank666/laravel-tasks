    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border:0px;">
          ...
          <div class="container">
            <div class="row">
                <div class="col-md-12">
                OTP sent to your number: <span id="mobileno" name="mobileno"></span>
                @if(Auth::user()){{Auth::user()->phone_code}}{{Auth::user()->mobile}}
                <button onclick="openVerifyMobileModal()" type="button" class="ml-5 btn btn-outline-warning btn-sm">Change</button>
                @else
                <button onclick="openRegisterModal()" type="button" class="ml-5 btn btn-outline-warning btn-sm">Change</button>
                @endif
               </div>
            </div>                 
        </div>
