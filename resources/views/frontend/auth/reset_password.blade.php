...
.form-label-group input:not(:placeholder-shown) ~ label {
  ...
  <body>
    <form class="form-resetpassword needs-validation"  method="POST" action="{{ route('password.request') }}" novalidate> 
    ...
    @endif
      ...
      @include('frontend.partials.message')
        ...
        <input id="email" name="email" type="email" placeholder="Emaill Address" class="form-control validate" value="{{ $email or old('email') }}" autofocus required>   
