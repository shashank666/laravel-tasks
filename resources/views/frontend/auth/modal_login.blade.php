<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content" style="border:0px;">
        ...
        <h5 class="modal-title  mx-auto" id="loginModalLabel"><!--<span style="vertical-align: bottom;margin-right:8px;">Login To</span>--><img src="/img/logo-white.png" width="90" height="30" alt="Opined"/></h5>
            ...
            <form  method="POST"  action="{{ route('login') }}">
                  ...
                  <div class="input-group mb-2">
                      <div class="input-group-prepend">
                          <div class="input-group-text" style="background-image: url(/img/emailphone.png);background-position:center; background-repeat:no-repeat;background-size:cover;width: 41px">
                            
                              <!--<i class="fas fa-envelope"></i>-->
                          </div>
                      </div>
                      <input id="login-email" name="email" type="text" class="form-control validate" value="{{ old('email') }}" autofocus="true" placeholder="Email / Mobile" required/>
                  </div>
